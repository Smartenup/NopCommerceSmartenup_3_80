...
namespace Nop.Plugin.Payments.PayPalStandard.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Payments.PayPalStandard.Fields.AdicionarNotaPrazoFabricaoEnvio")]
        public bool AdicionarNotaPrazoFabricaoEnvio { get; set; }

        public bool AdicionarNotaPrazoFabricaoEnvio_OverrideForStore { get; set; }

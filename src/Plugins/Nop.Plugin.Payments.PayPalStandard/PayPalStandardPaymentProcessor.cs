    ...
    public class PayPalStandardPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            if (_paypalStandardPaymentSettings.PassProductNamesAndTotals)
            {
                ...
                {
                    builder.AppendFormat("&item_name_" + x + "={0}", "Frete");
            ...
            builder.AppendFormat("&address1={0}", HttpUtility.UrlEncode(postProcessPaymentRequest.Order.BillingAddress.Address1 +", " + number + ", " + complement));
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalStandard.Fields.AdicionarNotaPrazoFabricaoEnvio", "Adicionar Prazo de Fabricação e Envio");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalStandard.Fields.AdicionarNotaPrazoFabricaoEnvio.Hint", "Habilitar para calcular o tempo de fabricação e de envido no pagamento do pedido");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalStandard.Fields.AdicionarNotaPrazoFabricaoEnvio");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalStandard.Fields.AdicionarNotaPrazoFabricaoEnvio.Hint");

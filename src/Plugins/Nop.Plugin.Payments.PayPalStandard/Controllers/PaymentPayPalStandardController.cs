...
namespace Nop.Plugin.Payments.PayPalStandard.Controllers
{
    public class PaymentPayPalStandardController : BasePaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            model.AdicionarNotaPrazoFabricaoEnvio = payPalStandardPaymentSettings.AdicionarNotaPrazoFabricaoEnvio;
            ...
            if (storeScope > 0)
            {
                ...
                model.AdicionarNotaPrazoFabricaoEnvio_OverrideForStore = _settingService.SettingExists(payPalStandardPaymentSettings, x => x.AdicionarNotaPrazoFabricaoEnvio, storeScope);
            }
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            payPalStandardPaymentSettings.AdicionarNotaPrazoFabricaoEnvio = model.AdicionarNotaPrazoFabricaoEnvio;
            ...
            _settingService.SaveSettingOverridablePerStore(payPalStandardPaymentSettings, x => x.AdicionarNotaPrazoFabricaoEnvio, model.AdicionarNotaPrazoFabricaoEnvio_OverrideForStore, storeScope, false);

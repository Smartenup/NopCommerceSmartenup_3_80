...
namespace Nop.Admin.Controllers
{
    public partial class ManufacturerController : BaseAdminController
    {
        ...
        [NonAction]
        protected virtual void PrepareManufacturingFields(ManufacturerModel model, Manufacturer manufacturer)
        {
            if (manufacturer != null)
            {
                model.ManufacturingOrderId = manufacturer.ManufacturingOrderId;
                model.DaysLessDeliveryDates = manufacturer.DaysLessDeliveryDates;
                model.SaleRepresentativeFirstName = manufacturer.SaleRepresentativeFirstName;
                model.SaleRepresentativeLastName = manufacturer.SaleRepresentativeLastName;
                model.SaleRepresentativeEmail = manufacturer.SaleRepresentativeEmail;
                model.CountryId = manufacturer.CountryId;
                model.StateProvinceId = manufacturer.StateProvinceId;
                model.City = manufacturer.City;
                model.ZipPostalCode = manufacturer.ZipPostalCode;
                model.Address = manufacturer.Address;
                model.AddressNumber = manufacturer.AddressNumber;
                model.AddressComplement = manufacturer.AddressComplement;
                model.PhoneNumber = manufacturer.PhoneNumber;
            }
            ...
            if (model.CountryId.HasValue)
            {
                ...
                //states
                var states = _stateProvinceService.GetStateProvincesByCountryId(model.CountryId.Value).ToList();
                if (states.Count > 0)
                {
        ...
        public ActionResult Create()
        {
            ...
            PrepareManufacturingFields(model, null);
        ...
        public ActionResult Create(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Manufacturing Order System
                UpdateManufacturingFields(model, manufacturer);
        ...
        [NonAction]
        private void UpdateManufacturingFields(ManufacturerModel model, Manufacturer manufacturer)
        {
            manufacturer.ManufacturingOrderId = model.ManufacturingOrderId;
            manufacturer.DaysLessDeliveryDates = model.DaysLessDeliveryDates;
            manufacturer.SaleRepresentativeFirstName = model.SaleRepresentativeFirstName;
            manufacturer.SaleRepresentativeLastName = model.SaleRepresentativeLastName;
            manufacturer.SaleRepresentativeEmail = model.SaleRepresentativeEmail;
            manufacturer.CountryId = model.CountryId;
            manufacturer.StateProvinceId = model.StateProvinceId;
            manufacturer.City = model.City;
            manufacturer.ZipPostalCode = model.ZipPostalCode;
            manufacturer.Address = model.Address;
            manufacturer.AddressNumber = model.AddressNumber;
            manufacturer.AddressComplement = model.AddressComplement;
        ...
        public ActionResult Edit(int id)
        {
            ...
            //Manufacturing Order System Fields
            PrepareManufacturingFields(model, manufacturer);
        ...
        public ActionResult Edit(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Update Manufacturing Order System Fields
                UpdateManufacturingFields(model, manufacturer);

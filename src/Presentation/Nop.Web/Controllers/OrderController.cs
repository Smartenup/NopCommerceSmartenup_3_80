    ...
    public partial class OrderController : BasePublicController
    {
        ...
        protected virtual OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            foreach (var orderItem in orderItems)
            {
                ...
                //delivery date
                var deliveryDate = _shippingService.GetDeliveryDateById(orderItem.Product.DeliveryDateId);
                if (deliveryDate != null)
                {
                    orderItemModel.DeliveryDate = deliveryDate.GetLocalized(dd => dd.Name);
                }							
